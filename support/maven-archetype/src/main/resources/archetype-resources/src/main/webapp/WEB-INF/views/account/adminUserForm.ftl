...
<body>
	<form id="inputForm" action="${symbol_dollar}{request.contextPath}/admin/user/update" method="post" class="form-horizontal">
		...
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<span class="help-inline" style="padding:5px 0px">${symbol_dollar}{user.registerDate!}</span>
				</div>
			</div>
